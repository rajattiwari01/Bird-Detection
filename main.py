# -*- coding: utf-8 -*-
"""
Created on Fri Aug 28 16:41:47 2020
...
if __name__ == "__main__":
    ...
    if demo == 1:
        ...
        # YOLO Pipeline
        video_output = 'examples/project_YOLO_bird.mp4'
        clip1 = VideoFileClip("examples/bird.mp4").subclip(1,20)
        ...
        clip1 = VideoFileClip("examples/project_video.mp4").subclip(11,45)
